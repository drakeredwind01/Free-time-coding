...
def main():
  ...
  """
  while True:
    find_and_click('D:\\Documents\\github\\Free-time-coding\\pyautogui\\IMAGE_PATH\\download_this_video.png', 'hit vm')
    find_and_click('D:\\Documents\\github\\Free-time-coding\\pyautogui\\IMAGE_PATH\\start_download.png', 'hit beta')
    find_and_click('D:\\Documents\\github\\Free-time-coding\\pyautogui\\IMAGE_PATH\\down_continue_background.png', 'hit beta')
